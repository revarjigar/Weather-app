...
export class GetWeatherService implements OnInit {
  ...
  getRandomBackgroundColor(): void {
    let gradient = this.gradientList();
    let dom = document.getElementById('radial-center');
  ...
  gradientList(): string {
    var gradient = [
      ...
      'rgb(99, 99, 99), rgb(162, 171, 88)',
      'rgb(173, 83, 137), rgb(60, 16, 83)',
      'rgb(168, 192, 255), rgb(63, 43, 150)',
      'rgb(51, 51, 51), rgb(221, 24, 24)',
      'rgb(78, 84, 200), rgb(143, 148, 251)',
      'rgb(53, 92, 125), rgb(108, 91, 123), rgb(192, 108, 132)',
      'rgb(188, 78, 156), rgb(248, 7, 89)',
      'rgb(64, 224, 208), rgb(255, 140, 0), rgb(255, 0, 128)',
      'rgb(62, 81, 81), rgb(222, 203, 164)',
      'rgb(17, 153, 142), rgb(56, 239, 125)',
      'rgb(16, 141, 199), rgb(239, 142, 56)',
      'rgb(252, 92, 125), rgb(106, 130, 251)',
      'rgb(252, 70, 107), rgb(63, 94, 251)',
      'rgb(201, 75, 75), rgb(75, 19, 79)',
      'rgb(35, 7, 77), rgb(204, 83, 51)',
      'rgb(255, 251, 213), rgb(178, 10, 44)',
      'rgb(15, 12, 41), rgb(48, 43, 99), rgb(36, 36, 62)',
      'rgb(0, 176, 155), rgb(150, 201, 61)',
      'rgb(211, 204, 227), rgb(233, 228, 240)',
      'rgb(60, 59, 63), rgb(96, 92, 60)',
      'rgb(202, 197, 49), rgb(243, 249, 167)',
      'rgb(128, 0, 128), rgb(255, 192, 203)',
      'rgb(0, 242, 96), rgb(5, 117, 230)',
      'rgb(252, 74, 26), rgb(247, 183, 51)',
      'rgb(225, 238, 195), rgb(240, 80, 83)',
      'rgb(116, 235, 213), rgb(172, 182, 229)',
      'rgb(109, 96, 39), rgb(211, 203, 184)',
      'rgb(3, 0, 30), rgb(115, 3, 192), rgb(236, 56, 188), rgb(253, 239, 249)',
      'rgb(102, 125, 182), rgb(0, 130, 200), rgb(0, 130, 200), rgb(102, 125, 182)',
      'rgb(173, 169, 150), rgb(242, 242, 242), rgb(219, 219, 219), rgb(234, 234, 234)',
      'rgb(225, 238, 195), rgb(240, 80, 83)',
      'rgb(26, 42, 108), rgb(178, 31, 31), rgb(253, 187, 45)',
      'rgb(34, 193, 195), rgb(253, 187, 45)',
      'rgb(255, 153, 102), rgb(255, 94, 98)',
      'rgb(127, 0, 255), rgb(225, 0, 255)',
      'rgb(201, 214, 255), rgb(226, 226, 226)',
      'rgb(57, 106, 252), rgb(41, 72, 255)',
      'rgb(217, 167, 199), rgb(255, 252, 220)',
      'rgb(7, 0, 0), rgb(76, 0, 1), rgb(7, 0, 0)',
      'rgb(0, 0, 0), rgb(229, 0, 141), rgb(255, 7, 11)',
      ...
      'rgb(156, 236, 251), rgb(101, 199, 247), rgb(0, 82, 212)',
      ...
      'rgb(82, 194, 52), rgb(6, 23, 0)',
      'rgb(254, 140, 0), rgb(248, 54, 0)',
      'rgb(0, 198, 255), rgb(0, 114, 255)',
      'rgb(112, 225, 245), rgb(255, 209, 148)',
      'rgb(85, 98, 112), rgb(255, 107, 107)',
      'rgb(157, 80, 187), rgb(110, 72, 170)',
      'rgb(120, 2, 6), rgb(6, 17, 97)',
      'rgb(179, 255, 171), rgb(18, 255, 247)',
      'rgb(170, 255, 169), rgb(17, 255, 189)',
      'rgb(0, 0, 0), rgb(231, 76, 60)',
      'rgb(240, 194, 123), rgb(75, 18, 72)',
      'rgb(255, 78, 80), rgb(249, 212, 35)',
      'rgb(173, 209, 0), rgb(123, 146, 10)',
      'rgb(251, 211, 233), rgb(187, 55, 125)',
      'rgb(0, 0, 0), rgb(83, 52, 109)',
      'rgb(96, 108, 136), rgb(63, 76, 107)',
      'rgb(201, 255, 191), rgb(255, 175, 189)',
      'rgb(100, 145, 115), rgb(219, 213, 164)',
      'rgb(185, 147, 214), rgb(140, 166, 219)',
      'rgb(135, 0, 0), rgb(25, 10, 5)',
      'rgb(0, 210, 255), rgb(58, 123, 213)',
      'rgb(211, 149, 155), rgb(191, 230, 186)',
      'rgb(218, 210, 153), rgb(176, 218, 185)',
      'rgb(230, 218, 218), rgb(39, 64, 70)',
      'rgb(93, 65, 87), rgb(168, 202, 186)',
      'rgb(221, 214, 243), rgb(250, 172, 168)',
      'rgb(97, 97, 97), rgb(155, 197, 195)',
      'rgb(80, 201, 195), rgb(150, 222, 218)',
      'rgb(33, 95, 0), rgb(228, 228, 217)',
      'rgb(194, 21, 0), rgb(255, 197, 0)',
      'rgb(239, 239, 187), rgb(212, 211, 221)',
      'rgb(255, 238, 238), rgb(221, 239, 187)',
      'rgb(102, 102, 0), rgb(153, 153, 102)',
      'rgb(222, 98, 98), rgb(255, 184, 140)',
      'rgb(233, 211, 98), rgb(51, 51, 51)',
      'rgb(213, 51, 105), rgb(203, 173, 109)',
      'rgb(167, 55, 55), rgb(122, 40, 40)',
      'rgb(248, 87, 166), rgb(255, 88, 88)',
      ...
      'rgb(116, 116, 191), rgb(52, 138, 199)',
      'rgb(236, 233, 230), rgb(255, 255, 255)',
      'rgb(218, 226, 248), rgb(214, 164, 164)',
      'rgb(237, 66, 100), rgb(255, 237, 188)',
      'rgb(220, 36, 36), rgb(74, 86, 157)',
      'rgb(36, 198, 220), rgb(81, 74, 157)',
      'rgb(40, 48, 72), rgb(133, 147, 152)',
      'rgb(61, 126, 170), rgb(255, 228, 122)',
      'rgb(28, 216, 210), rgb(147, 237, 199)',
      'rgb(35, 37, 38), rgb(65, 67, 69)',
      'rgb(117, 127, 154), rgb(215, 221, 232)',
      'rgb(92, 37, 141), rgb(67, 137, 162)',
      'rgb(19, 78, 94), rgb(113, 178, 128)',
      'rgb(43, 192, 228), rgb(234, 236, 198)',
      'rgb(8, 80, 120), rgb(133, 216, 206)',
      'rgb(71, 118, 230), rgb(142, 84, 233)',
      'rgb(97, 67, 133), rgb(81, 99, 149)',
      'rgb(31, 28, 44), rgb(146, 141, 171)',
      'rgb(22, 34, 42), rgb(58, 96, 115)',
      'rgb(255, 128, 8), rgb(255, 200, 55)',
      'rgb(29, 151, 108), rgb(147, 249, 185)',
      'rgb(235, 51, 73), rgb(244, 92, 67)',
      'rgb(221, 94, 137), rgb(247, 187, 151)',
      'rgb(76, 184, 196), rgb(60, 211, 173)',
      'rgb(31, 162, 255), rgb(18, 216, 250), rgb(166, 255, 203)',
      'rgb(29, 43, 100), rgb(248, 205, 218)',
      'rgb(255, 81, 47), rgb(240, 152, 25)',
      'rgb(26, 41, 128), rgb(38, 208, 206)',
      'rgb(170, 7, 107), rgb(97, 4, 95)',
      'rgb(255, 81, 47), rgb(221, 36, 118)',
      'rgb(240, 152, 25), rgb(237, 222, 93)',
      'rgb(64, 59, 74), rgb(231, 233, 187)',
      'rgb(229, 93, 135), rgb(95, 195, 228)',
      'rgb(0, 57, 115), rgb(229, 229, 190)',
      'rgb(204, 149, 192), rgb(219, 212, 180), rgb(122, 161, 210)',
      'rgb(60, 165, 92), rgb(181, 172, 73)',
      'rgb(52, 143, 80), rgb(86, 180, 211)',
      'rgb(218, 34, 255), rgb(151, 51, 238)',
      'rgb(2, 170, 176), rgb(0, 205, 172)',
      'rgb(237, 229, 116), rgb(225, 245, 196)',
      'rgb(211, 16, 39), rgb(234, 56, 77)',
      'rgb(22, 160, 133), rgb(244, 208, 63)',
      'rgb(96, 56, 19), rgb(178, 159, 148)',
      'rgb(229, 45, 39), rgb(179, 18, 23)',
      'rgb(255, 110, 127), rgb(191, 233, 255)',
      'rgb(119, 161, 211), rgb(121, 203, 202), rgb(230, 132, 174)',
      'rgb(49, 71, 85), rgb(38, 160, 218)',
      'rgb(43, 88, 118), rgb(78, 67, 118)',
      'rgb(230, 92, 0), rgb(249, 212, 35)',
      'rgb(33, 147, 176), rgb(109, 213, 237)',
      'rgb(204, 43, 94), rgb(117, 58, 136)',
      'rgb(236, 0, 140), rgb(252, 103, 103)',
      'rgb(20, 136, 204), rgb(43, 50, 178)',
      'rgb(0, 70, 127), rgb(165, 204, 130)',
      'rgb(7, 101, 133), rgb(255, 255, 255)',
      'rgb(187, 210, 197), rgb(83, 105, 118)',
      'rgb(183, 152, 145), rgb(148, 113, 107)',
      'rgb(187, 210, 197), rgb(83, 105, 118), rgb(41, 46, 73)',
      'rgb(83, 105, 118), rgb(41, 46, 73)',
      'rgb(172, 182, 229), rgb(134, 253, 232)',
      'rgb(255, 226, 89), rgb(255, 167, 81)',
      'rgb(2, 17, 29), rgb(3, 123, 181), rgb(2, 17, 29)'
    ];
